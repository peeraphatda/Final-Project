...
| :--- | :---: | :--- |
| **นายปฏิภาณ นามสีลี** | ท็อป | **Planner / Architect** (วางโครงสร้าง Web Architecture, UI/UX Glassmorphism & i18n System) |
| **นายปฏิพัฒน์ หอทอง** | ปลั๊ก | **Coder & DevOps** (พัฒนา Frontend Dashboard, JavaScript Core & GitHub Actions CI/CD) |
| **นายกฤษฎา สายวัน** | กาย | **Debugger / QA** (ทดสอบการสกัดสีจากรูปภาพ Image Extractor & Cross-Browser Testing) |
| **นายภีรภัทร ด่านภูมิพัฒนา** | ภีม | **Debugger / QA & Deployment** (ตรวจสอบระบบ GitHub Pages Deployment & Automated Build Scripts) |
